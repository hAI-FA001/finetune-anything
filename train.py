...
if __name__ == "__main__":
    ...
    val_dataset = get_dataset(val_cfg.dataset)  # type: ignore
    val_loader = DataLoader(
        val_dataset,
        batch_size=val_cfg.bs,
        shuffle=False,
    ...
    print(f"Input Data Shape: {train_shape}")
    print(f"Target Data Shape: {train_loader.dataset[0][1].shape}")
    summary(model, (train_cfg.bs, *list(train_shape)))

    opt_params = get_opt_pamams(
        model,
